...
class PlacesTableViewController: UITableViewController {
    ...
    init(userLocation: CLLocation, places: [PlaceAnnotation]) {
        ...
        // identify row if there is one selected (initial value is 0)
    ...
    // show details of place that is selected
    ...
    // is responsible for returning back the actual cell to the user
